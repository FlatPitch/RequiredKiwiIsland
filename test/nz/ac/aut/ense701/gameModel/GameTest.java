...
public class GameTest extends junit.framework.TestCase
{
    ...
    protected void setUp()
    {
        ...
        game           = new Game();
        game.createNewGame("maps/IslandData.txt");
 ...
 *********************************************************************************************************/
    ...
    public void testCanCollectCollectable(){
        ...
        Item valid = new Food(playerPosition,"Sandwich", "Yummy",1.0, 1.0,1.0,null,null);
    ...
    public void testCanCollectNotCollectable(){
        ...
        Item notCollectable = new Food(playerPosition,"Sandwich", "Very Heavy Sandwich",10.0, 0.0,1.0,null,null);
    ...
    public void testCollectValid(){
        Item food = new Food(playerPosition,"Sandwich", "Yummy",1.0, 1.0,1.0,null,null);
    ...
    public void testCollectNotCollectable(){
        Item notCollectable = new Food(playerPosition,"House", "Can't collect",1.0, 0.0,1.0,null,null);
    ...
    public void testDropNotValidPositionFull(){
        ...
        Item dummy = new Tool(playerPosition,"Trap", "An extra occupant", 1.0, 1.0,null,null);
        Item dummy2 = new Tool(playerPosition,"Trap", "An extra occupant", 1.0, 1.0,null,null);
        Item dummy3 = new Tool(playerPosition,"Trap", "An extra occupant", 1.0, 1.0,null,null);
    ...
    public void testUseItemFoodCausesIncrease(){
        Item food = new Food(playerPosition,"Sandwich", "Yummy",1.0, 1.0,1.3,null,null);
        player.collect(food);
        assertTrue("Player should have food",player.hasItem(food));
